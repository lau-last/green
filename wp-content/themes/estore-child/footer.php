	...
	<div id="bottom-footer" class="clearfix">
		<div class="tg-container">
			<div class="copy-right">
				<?php printf(esc_html__('Copyright &copy; Laurent Lassallette %1$s %2$s. All rights reserved.', 'estore'), date('Y'), '<a href="' . esc_url(home_url('/')) . '" title="' . esc_attr(get_bloginfo('name', 'display')) . '" ><span>' . get_bloginfo('name', 'display') . '</span></a>'); ?>
			</div>
			<?php
			$logos = array();
			for ($i = 1; $i < 5; $i++) {
